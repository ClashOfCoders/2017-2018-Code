...
public class RedSide extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        robot.gyroDrive(this,0.25,180,20,2,0);
        boolean counterClock=true;
        robot.gyroTurn(this,0.4,90,counterClock);
        ...
        robot.gyroDrive(this,0.25,0,2,10,90);
        ...
        timeStart=this.getRuntime();
        rY=0;

        while (this.opModeIsActive() &&  Math.abs(tZ)>625)  {
            ...
            if (vuMark != RelicRecoveryVuMark.UNKNOWN) {
                ...
                if (pose != null) {
                    ...
                    robot.angleDrive(this, 0.25, 0, rotation);
        ...
        double targetCorrection=(tX-30)/25.4*4.5/7.5;
        if(vuPosition== 1)
            targetDistance=(5-targetCorrection);
        else if(vuPosition== 2)
            targetDistance=(11-targetCorrection);
        else if(vuPosition== 3)
            targetDistance=(17-targetCorrection);
        else  targetDistance=5;
        robot.gyroDrive(this,0.36,270,targetDistance,10,gyroTarget);
        robot.gyroDrive(this,0.25,0,2,10,gyroTarget);
