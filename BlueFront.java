...
/**
 * Created by jianqiuzhang on 1/23/18.
 */
...
// first read the the vuMark and drive off the ramp
        ...
        while (this.opModeIsActive() &&   Math.abs(tZ)<890) {
            ...
            if (vuMark != RelicRecoveryVuMark.UNKNOWN) {
                ...
                if (pose != null) {
                    ...
                    robot.angleDrive(this, 0.25, 90, rotation);
        ...
        double gyroTarget=robot.gyroAngle(robot.gyro.getIntegratedZValue())+rY;
        gyroTarget=0;
        robot.gyroDrive(this,0.25,0,targetDistance,20,gyroTarget);



        double tZCorrection=(Math.abs(tZ)-890)/25.4*4.5/7.5;
        if(vuPosition==1)
            targetDistance=tZCorrection;
        else if(vuPosition== 2)
            targetDistance=(tZCorrection+5);
        else if(vuPosition== 3)
            targetDistance=(tZCorrection+10);
        else  targetDistance=0;



        if (targetDistance>0){
            if(targetDistance<0 && vuPosition==1){
                robot.angleDrive(this,0.25,90,rotation);
                robot.gyroDrive(this,0.25,90,targetDistance,0.5,gyroTarget);
            }
            else
                robot.gyroDrive(this,0.25,270,targetDistance,5,gyroTarget);

        }

        robot.gyroDrive(this,0.25,0,6,1,gyroTarget);
